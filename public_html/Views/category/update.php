    ...
    <div class="card-body">
        ...
        <form action="<?= base_url('KMS/knowledgecategory/' . $category['idkategori']); ?>" method="post">
            ...
            <div class="my-3">
                ...
                <input type="text" class="form-control <?php if ($validation->hasError('category')) : ?>is-invalid<?php endif ?>" id="category" name="category" value="<?= $oldInput['category'] ?? $category['namakategori']; ?>" required>
