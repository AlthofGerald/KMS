...
<div class="card">
    <div class="card-body">
        <h5 class="card-title fw-semibold">Update Pengetahuan Tacit</h5>
        <form action="<?= base_url("KMS/mytacit/{$knowledge['slug']}/update"); ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field(); ?>
