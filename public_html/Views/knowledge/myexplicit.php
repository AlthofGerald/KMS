...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Pengetahuan Explicit Saya</h4>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        <div class="row mb-3">
            ...
            <div class="d-flex justify-content-between mb-2">
                ...
                <div>
                    <a href="<?= base_url('KMS/myexplicit/new'); ?>" class="btn btn-primary">
                        <i class="ti ti-plus"></i>
                        Tambah Pengetahuan Explicit
                    </a>
                </div>
            </div>
            ...
            <tbody class="table-group-divider">
                ...
                <?php foreach ($knowledge as $knowledge) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url("KMS/myexplicit/{$knowledge['slug']}/edit"); ?>" class="d-block btn btn-primary w-100 mb-2">
                                <i class="ti ti-edit"></i>
                                Edit
                            </a>
                            <form action="<?= base_url("KMS/myexplicit/{$knowledge['slug']}"); ?>" method="post">
                                <?= csrf_field(); ?>
